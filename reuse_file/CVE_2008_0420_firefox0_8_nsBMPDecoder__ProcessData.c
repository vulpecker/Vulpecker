...
NS_METHOD CVE_2008_0420_firefox0_8_nsBMPDecoder::ProcessData(const char* aBuffer, PRUint32 aCount)
{
    PR_LOG(gBMPLog, PR_LOG_DEBUG, ("CVE_2008_0420_firefox0_8_nsBMPDecoder::ProcessData(%p, %lu)", aBuffer, aCount));
