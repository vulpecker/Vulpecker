...
NS_IMETHODIMP
CVE_2013_5597_thunderbird6_0_2_nsOfflineCachePendingUpdate::OnStateChange(nsIWebProgress* aWebProgress,
                                           nsIRequest *aRequest,
                                           ...
                                           nsresult aStatus)
{
    ...
    LOG(("CVE_2013_5597_thunderbird6_0_2_nsOfflineCachePendingUpdate::OnStateChange [%p, doc=%p]",
